...
export const NavBarCenter = component$(() => {
  ...
  const dropdownMenu = isOpenDraw.isOpenDraw ? (
    <div class="dropdown-menu"><div class="dropdown-arrow"></div>
       <img
              width={60}
              height={40}
              src={
            ...
            <span class="user-name">{user?.name}</span> <span class="user-company">Administrator in </span>
          ...
          <div class="separator"/>
          <p> {store?.name} </p>
          <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path fill="currentColor" d="M8 18h6v2H8zm0 4h10v2H8z"/><path fill="currentColor" d="M26 4H6a2.002 2.002 0 0 0-2 2v20a2.002 2.002 0 0 0 2 2h20a2.002 2.002 0 0 0 2-2V6a2.002 2.002 0 0 0-2-2Zm-8 2v4h-4V6ZM6 26V6h6v6h8V6h6l.001 20Z"/></svg> Products</a>
          <a href="#">  <svg
      ...
      <a href="/auth/logout/?rr=/"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>Sign Out</a>
    </div>
  ) : null;
  return (
    <>
