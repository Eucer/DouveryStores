      ...
      <nav class="navbar">
        ...
        <ul class="nav-links">
          <li class="tabs-nav">
            ...
            <div class="tooltip">Información sobre gestión de productos</div>
          </li>
          <li class="tabs-nav">
            <span>
          ...
          <li class="tabs-nav">
            ...
            <div class="tooltip">Información sobre soporte</div>
          </li>
          <li class="tabs-nav">
            <span>
              Preguntas frecuentes <DouveryArrowDown size={20} />
            </span>
            <div class="tooltip">Información sobre preguntas frecuentes</div>
          </li>
        </ul>
